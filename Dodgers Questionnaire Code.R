...
### Question C      
      ...
      # Predict the Genre 
      genre$pred <- genRF$predicted  ## predicted genre
      genre$vote <- genRF$vote       ## number of decision trees to have made that prediction: 
                                     ## low vote percentages would indicate if they were mislabelled. 
